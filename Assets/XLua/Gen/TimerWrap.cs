    ...
    public class TimerWrap 
    {
        ...
        static int _m_Register_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<System.Action>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Action<float>>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)&& translator.Assignable<UnityEngine.MonoBehaviour>(L, 6)) 
                {
                    float _duration = (float)LuaAPI.lua_tonumber(L, 1);
                    System.Action _onComplete = translator.GetDelegate<System.Action>(L, 2);
                    bool _isLooped = LuaAPI.lua_toboolean(L, 3);
                    ...
                    UnityEngine.MonoBehaviour _autoDestroyOwner = (UnityEngine.MonoBehaviour)translator.GetObject(L, 6, typeof(UnityEngine.MonoBehaviour));
                        ...
                        Timer gen_ret = Timer.Register( _duration, _onComplete, _isLooped, _onUpdate, _useRealTime, _autoDestroyOwner );
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<System.Action>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Action<float>>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    float _duration = (float)LuaAPI.lua_tonumber(L, 1);
                    System.Action _onComplete = translator.GetDelegate<System.Action>(L, 2);
                    bool _isLooped = LuaAPI.lua_toboolean(L, 3);
                    ...
                    bool _useRealTime = LuaAPI.lua_toboolean(L, 5);
                        ...
                        Timer gen_ret = Timer.Register( _duration, _onComplete, _isLooped, _onUpdate, _useRealTime );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<System.Action>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Action<float>>(L, 4)) 
                {
                    float _duration = (float)LuaAPI.lua_tonumber(L, 1);
                    System.Action _onComplete = translator.GetDelegate<System.Action>(L, 2);
                    bool _isLooped = LuaAPI.lua_toboolean(L, 3);
                    System.Action<float> _onUpdate = translator.GetDelegate<System.Action<float>>(L, 4);
                        ...
                        Timer gen_ret = Timer.Register( _duration, _onComplete, _isLooped, _onUpdate );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& translator.Assignable<System.Action>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _isLooped = LuaAPI.lua_toboolean(L, 3);
                        ...
                        Timer gen_ret = Timer.Register( _duration, _onComplete, _isLooped );
                        translator.Push(L, gen_ret);
