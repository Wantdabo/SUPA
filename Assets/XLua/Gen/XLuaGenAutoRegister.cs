...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(AssetLoader), AssetLoaderWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(SceneLoader), SceneLoaderWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Timer), TimerWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Log), LogWrap.__Register);
