...
public class Timer
{
    ...
    public static Timer Register(float duration, Action onComplete, bool isLooped = false, Action<float> onUpdate = null, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
    {
